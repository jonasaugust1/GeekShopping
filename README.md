...
Products, Cart and Login Apis. For login i used Identity server with [Duende Framework](https://duendesoftware.com/){:target="_blank"}. For frontend I used Aspnet with razor pages.
